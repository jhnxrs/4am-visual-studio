...
export const Work = () => {
    ...
    return (
        <section ref={sectionRef} className="w-screen py-32 px-12 flex flex-col relative bg-white z-20">
                        ...
                        return (
                            <div key={word} className="flex flex-row items-center">
                                {word.split('').map((letter, index) => {
                                    return (
                                        <span key={index} className="text-black text-[120px] font-black">{letter}</span>
                                    )
                                })}
                            </div>
                        )
            ...
            <div className="w-full flex flex-col" id="work-content">
                <div className="w-full flex flex-row items-end gap-5">
